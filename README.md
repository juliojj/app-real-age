...
>The pre-trained model (stage 2) used to generate the results reported in the paper can be downloaded <a href="http://158.109.8.102/AppaRealAgeFG19/vgg16_app-real-age_fg2019_stage_2_st1-lr_0.0001_st2-lr_0.0001.hdf5">here</a>. You can copy it to 'best_models' directory and make predictions on the test set without the need of doing the training.
